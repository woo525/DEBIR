...
from datasets.dataset_stage3 import GoProRAW2RAW as GoProRAW2RAW_train
...
class Args:
    def __init__(self):
        ...
        self.exp_name = os.path.join(log_dir, "debir_obf")
        self.pretrained_baenet = "debir_ob"
...
train_dataset = GoProRAW2RAW_train(root=args.image_dir, split='train', patch_size=args.patch_size, args=args)
...
model = Burstormer(args=args) # Burstormer
model.cuda()
