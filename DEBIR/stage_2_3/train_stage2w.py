...
from Network_BAENet_stage2w import Burstormer
from datasets.dataset_stage2w import GoProRAW2RAW
...
class Args:
    def __init__(self):
        ...
        self.exp_name = os.path.join(log_dir, "debir_o")
...
checkpoint_callback = ModelCheckpoint(
    ...
    filename='{epoch:03d}-{val_psnr:.3f}',
    save_top_k=1,
    save_last=True,
    mode='min',
)
